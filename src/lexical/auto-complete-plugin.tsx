...
import {
  ...
  AutocompleteNode,
} from "@/lexical/autocomplete-node";
import { addSwipeRightListener } from "@/lexical/swipe";
...
import type { SearchPromise } from "@/lexical/autocomplete-corpus";
...
function useQuery(): (searchText: string) => SearchPromise {
  const { autocomplete, mentions } = useRichTextEditorConfig();
  const queryFn = useMemo(
    () => createAutocompleteQuery(autocomplete, mentions, DICTIONARY),
...
export function AutoCompletePlugin(): JSX.Element | null {
  ...
  const { enabled } = useAutocompleteEnabled();
