...
let dragImageEl: HTMLImageElement | null = null;

function getDragImageElement(): HTMLImageElement {
  if (dragImageEl === null && typeof document !== "undefined") {
    const el = document.createElement("img");
    el.src = TRANSPARENT_IMAGE;
    dragImageEl = el;
  }
  return dragImageEl as HTMLImageElement;
}
...
function $onDragStart(event: DragEvent): boolean {
  ...
  dataTransfer.setDragImage(getDragImageElement(), 0, 0);
